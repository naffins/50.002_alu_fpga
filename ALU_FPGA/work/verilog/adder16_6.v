...
module adder16_6 (
  ...
  always @* begin
    ...
    endcase
    M_fa0_a = a[0+0-:1];
    M_fa0_b = b_processed[0+0-:1];
    M_fa0_cin = alufn[0+0-:1];
    s_int[0+0-:1] = M_fa0_s;
    cout[0+0-:1] = M_fa0_cout;
    M_fa1_a = a[1+14-:15];
    M_fa1_b = b_processed[1+14-:15];
    ...
    v = (a[15+0-:1] & b_processed[15+0-:1] & (~s_int[15+0-:1])) | ((~a[15+0-:1]) & (~b_processed[15+0-:1]) & s_int[15+0-:1]);
    n = s_int[15+0-:1];
  end
endmodule
